    ...
    return (
      <div className="w-full max-w-2xl">
        <div className="hero max-w-sm mt-80">
          ...
          <p className="mt-8 leading-tight lg:text-2xl">I'm a full-stack developer from Los Angeles, CA. I specialize in front-end development with a keen eye for design and user experience. I'm currently seeking new opportunities.</p>
