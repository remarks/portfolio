  ...
  render() {
    return (
      <div className="hero max-w-lg leading-normal">
        <h1 className="leading-tight">Hi, I'm Mark Pinero.</h1>
        ...
        <p className="mt-8 lg:text-2xl">
          <a href="mailto:mark@markpinero.com" className="no-underline font-bold border-b border-pink">I'm available for part-time consulting or coffee.</a>
        </p>
      </div>
    )
  }
